---
title: 'Stripe Setup'
description: 'Learn how to set up and configure Stripe payments in your application'
---
...
```bash
bun add @better-auth/stripe stripe @stripe/stripe-js
```
...
2. Configure BetterAuth with Stripe plugin:
