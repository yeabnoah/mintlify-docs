...
description: 'Best practices and patterns for development'
---

# Development Guide

This guide outlines the best practices and patterns to follow when developing with the Ultimate Cursor AI Boilerplate.
...
2. Include all feature-specific components, hooks, and utilities
