---
title: 'AI Components'
description: 'Learn about the pre-built AI components available in the boilerplate'
---

# AI Components

The Ultimate Boilerplate includes several pre-built AI components that you can use to quickly add AI features to your application.
...
- Learn about [Server Actions](/docs/ai/server-actions)
- Explore [Use Cases](/docs/ai/use-cases)
- Check out [OpenRouter Integration](/docs/ai/openrouter) 