...
> **Note:** Only fields and patterns already present in the codebase are supported. For more options, refer to the [Next.js Metadata docs](https://nextjs.org/docs/app/building-your-application/optimizing/metadata). 