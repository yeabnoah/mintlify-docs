...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6">
  <div className="border rounded-lg p-4 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20">
    ...
    <p className="text-sm text-gray-600 dark:text-gray-400">Next.js web app</p>
  </div>
  ...
  <div className="border rounded-lg p-4 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20">
    <div className="text-2xl mb-2">📝</div>
    <h3 className="font-semibold text-lg mb-1">CMS</h3>
  ...
  <div className="border rounded-lg p-4 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20">
    ...
    <p className="text-sm text-gray-600 dark:text-gray-400">Google OAuth + email</p>
  </div>
  
  <div className="border rounded-lg p-4 bg-gradient-to-br from-pink-50 to-pink-100 dark:from-pink-900/20 dark:to-pink-800/20">
    <div className="text-2xl mb-2">💳</div>
  ...
  <div className="border rounded-lg p-4 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20">
    <div className="text-2xl mb-2">📧</div>
    <h3 className="font-semibold text-lg mb-1">Email</h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">Resend service</p>
  </div>
  
  <div className="border rounded-lg p-4 bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-800/20">
    <div className="text-2xl mb-2">🤖</div>
    <h3 className="font-semibold text-lg mb-1">AI</h3>
    <p className="text-sm text-gray-600 dark:text-gray-400">OpenRouter integration</p>
  </div>
</div>
