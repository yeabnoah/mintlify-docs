...
description: 'Learn how to create and use API routes that require an active subscription'
---
...
export const premiumRouter = router({
  // Get premium content
  getPremiumContent: subscribedProcedure.query(async ({ ctx }) => {
    return { content: 'premium data' };
  }),

  // Access premium feature
  usePremiumFeature: subscribedProcedure
    .input(z.object({
      featureId: z.string(),
    }))
