...
description: 'Learn how to create and use protected API routes that require authentication'
---
...
function ProfileComponent() {
  const { data: profile, isLoading } = trpc.profileRouter.getProfile.useQuery();
