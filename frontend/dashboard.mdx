...
description: 'Overview of the main dashboard, its structure, navigation, and all core features and settings for authenticated users in the Ultimate Boilerplate.'
---

The Dashboard is the central hub for authenticated users, providing access to all major features of the Ultimate Boilerplate: productivity tools, user profile, billing, and subscriptions.
